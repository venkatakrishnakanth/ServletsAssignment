...
<body>
<h1 style="color: white">Welcome to Patient Portal at Children's National</h1>
  ...
  <div id="w">
    <div id="content">
      ...
      <div class="notify successbox">
        ...
        <p>Your payment has been Processed. We will notfy you by email in 10 days.</p><br>
        
      </div>

      <div class = "flatbtn">
        
        <a href="login.jsp" type="button" id="button">Logout</a>

...
<h1>Welcome to Patient Portal at Children's National</h1>
<body>
  ...
  <div id="w">
    <div id="content">
      ...
      <div class="notify successbox">
        ...
        <p>You have registerd succesfully with Nations'Children Hospital</p><br>
        <p>Please login to access your bills and payments sections.<p>
      </div>

      <div class = "flatbtn">
        
        <a href="/patientportal/login.jsp" type="button" id="button">Login</a>
	...
	<a href="/patientportal/login.jsp">Login</a>
